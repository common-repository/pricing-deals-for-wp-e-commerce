          ...
          * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * +
          + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + * + *           
            ...
            *********** 
                  ...
                  ********************************
                  REPLACE THIS IF..endif: (3 lines), If Pricing Deal "Old Price" messaging desired
                  ******************************** 
                  ...
                  *****
                  WITH:                                                    
                  *****
                      <?php echo do_action('vtprd_show_product_list_price_action'); ?>
                              *****
                              AND/OR
                              *****
                  ...
                  ***************
									KEEP THIS LINE (realtime price changes occur automatically)
                  ***************
                  ...
                  ********************************
                  REPLACE THIS IF..endif:  (3 lines), If Pricing Deal "You Save" messaging desired
                  ********************************
                      <?php if(wpsc_product_on_special()) : ?>
                  ...
                  *****
                  WITH:
                  *****
                      <?php echo do_action('vtprd_show_product_you_save_action'); ?>
