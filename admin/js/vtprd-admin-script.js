            ...
            //*************************************                             
                          ...
                          $("#buy-group-filter-select").change(function(){                                                       
                             buyGroupTest();

                             setRuleTemplate();
                             ruleTemplateChanged();
                             
                             //mirror the buy group upper select in the lower select
                             mirrorBuyGroupChange();                              
                                                         
                          });
                          
                          
                          $("#get-group-filter-select").change(function(){
                             getGroupTest();                             

                             //mirror the get group upper select in the lower select
                             mirrorGetGroupChange();  
                          });
                          ...
                          function pricingTypeTest() {     
                             ...
                             $('#buy-group-filter-select').attr("disabled", "disabled");
                             $('#get-group-filter-select').attr("disabled", "disabled");
                          ...
                          function minimumTest() {
                             ...
                             switch( $("#minimum-purchase-select").val() ) {                                
                               case "next":
                                     //reset get group choices, except for 'sameas buy'
                                     $('#get-group-filter-All').attr('disabled', false);
                                     $('#get-group-filter-Cart').attr('disabled', false);
                                     $('#get-group-filter-Group').attr('disabled', false);
                                     $('#get-group-filter-Single').attr('disabled', false);
                                     $('#get-group-filter-Vargroup').attr('disabled', false);
                                 break;                                                                   
                               case "none":   
                                     //protect get group choices, except for 'sameas buy'          
                                     $('#get-group-filter-All').attr('disabled', true);
                                     $('#get-group-filter-Cart').attr('disabled', true);
                                     $('#get-group-filter-Group').attr('disabled', true);
                                     $('#get-group-filter-Single').attr('disabled', true);
                                     $('#get-group-filter-Vargroup').attr('disabled', true);
                                 break;
                               case "choose":   
                                     $("#select_status_sw").val('no');
                                     return;
                             ...
                             //reset/protect Buy Group and Get Group subsequent selects
                             $('#buy-group-filter-select').removeAttr('disabled');
                             $('#get-group-filter-select').attr("disabled", "disabled");
                             ...
                             switch( $("#upperSelectsHaveDataFirstTime").val() ) {
                               ...
                               case '4' :  //data up to  buy_group_filter_select
                                   $('#get-group-filter-Choose').attr('selected', true);
                                 break; 
                               default:
                                   $('#buy-group-filter-Choose').removeAttr('disabled');
                                   $('#buy-group-filter-Choose').attr('selected', true);
                                   $('#get-group-filter-Choose').attr('selected', true);
                                 break;                                                              
                             }                              
                          ...
                          function buyGroupTest() {     
                             
                             $("#upperSelectsDoneSw").val('no');
                             
                             //for first-time only, really - in case a bad update was left behind
                             if ( $("#buy-group-filter-select").val() == "choose" ) {
                                $("#select_status_sw").val('no');
                                return;
                             } else {
                                $("#select_status_sw").val('yes');
                             ...
                             //test to release either the Get group select or the rest of the screen
                             switch( $("#pricing-type-select").val() ) {                                
                               case "all":
                               case "simple":
                                     
                                     //deactivate the Lower Get group area
                                     jQuery('#action_info_0').css('opacity', '0.4').css('filter', 'alpha(opacity=40)'); 
                                     ...
                                     //disable the 'choose' once a choice has been made
                                     $('#buy-group-filter-Choose').attr("disabled", "disabled");
                                     
                                 break;                                                                   
                               default:   
                                     //release JUST the Get group select
                                     $('#get-group-filter-select').removeAttr('disabled');
                                     
                                     //enable the 'choose' and reset to 'choose' 
                                     //  if no existing choices from first time there...
                                     if ($("#upperSelectsHaveDataFirstTime").val() < 5 ) {
                                        $('#get-group-filter-Choose').removeAttr('disabled');
                                        $('#get-group-filter-Choose').attr('selected', true);
                                        disableDates_lowerScreen();                                                                    
                                     } else {
                                        //disable the 'choose' once a choice has been made
                          ...
                          function getGroupTest() {     
                             ...
                             //for first-time only, really - in case a bad update was left behind
                             if ( $("#get-group-filter-select").val() == "choose" ) {
                                $("#select_status_sw").val('no');
                                return;
                             } else {
                                $("#select_status_sw").val('yes');
                             ...
                             //activate the Lower Get group area
                             jQuery('#action_info_0').css('opacity', '1').css('filter', 'alpha(opacity=100)');       
                              $('#action_amt_type_0').removeAttr('disabled');
                              $('#popChoiceOut').removeAttr('disabled');
                              $('#action_amt_mod_0').removeAttr('disabled');
                              $('#action_repeat_condition_0').removeAttr('disabled');
                             
                              
                              //disable the 'choose' once a choice has been made
                              $('#get-group-filter-Choose').attr("disabled", "disabled");
                          ...
                          function setWholeStore() { 
                             ...
                             //buy option
                             $('#buy-group-filter-Choose').attr('disabled', false);
                             $('#buy-group-filter-All').attr('disabled', false);//enabled                             
                             $('#buy-group-filter-Group').attr('disabled', true);
                             $('#buy-group-filter-Single').attr('disabled', true);
                             $('#buy-group-filter-Vargroup').attr('disabled', true);
                          ...
                          function setSimpleDiscount() { 
                             ...
                             //buy option
                             $('#buy-group-filter-All').attr('disabled', false);//enabled
                             $('#buy-group-filter-Group').attr('disabled', false);
                             $('#buy-group-filter-Single').attr('disabled', false);
                             $('#buy-group-filter-Vargroup').attr('disabled', false);
                          ...
                          function setBuyGroupAsBuy() {                              
                            ...
                            //if lits not already set correctly, reload them...  
                            if ( $('select[name=buy-group-filter-select1]').find('option').eq(1).text() !=
                                 $('select[name=buy-group-filter-select]').find('option').eq(1).text() ) {
                               //reload the buy titles as Buy
                               reload_BuyGroupFilterSelect_Titles1();                            
                               reload_buy_amt_type_Titles1();                            
                               reload_buy_amt_applies_to_Titles1();                           
                               reload_buy_amt_mod_Titles1();
                               reload_buy_repeat_condition_Titles1();                          
                               reload_popChoiceIn_Titles1();                     
                               reload_specChoice_in_Titles1();
                             };
                          ...
                          function setBuyGroupAsDiscount() {                              
                            ...
                            //if lits not already set correctly, reload them...
                            if ( $('select[name=buy-group-filter-select2]').find('option').eq(1).text() !=
                                 $('select[name=buy-group-filter-select]').find('option').eq(1).text() ) {
                               //reload the buy titles as Discount
                               reload_BuyGroupFilterSelect_Titles2();                            
                               reload_buy_amt_type_Titles2();                            
                               reload_buy_amt_applies_to_Titles2();                           
                               reload_buy_amt_mod_Titles2();
                               reload_buy_repeat_condition_Titles2();                          
                               reload_popChoiceIn_Titles2();                     
                               reload_specChoice_in_Titles2(); 
                             };
                          ...
                          function reset_Buy_Get_Min_to_Choose() {                              
                          ...
                          //mirror upper select change to main body options
                          function mirrorBuyGroupChange() {                              

                             switch( $("#buy-group-filter-select").val() ) {
                                case "wholeStore":                       
                                    $('#cartChoiceIn').attr('selected', true);
                                  break;
                                case "groups":                       
                                    $('#groupChoiceIn').attr('selected', true);
                                  break;                               
                                case "vargroup":                       
                                    $('#varChoiceIn').attr('selected', true);
                                  break;                                
                                case "single":                       
                                    $('#singleChoiceIn').attr('selected', true);
                                  break;                                                                                                                                                                       
                             };
                          };  
                          
                          //mirror upper select change to main body options         
                          function mirrorGetGroupChange() { 
                             
                             switch( $("#get-group-filter-select").val() ) {
                                case "sameAsInPop":                       
                                    $('#sameChoiceOut').attr('selected', true);
                                  break;                                  
                                case "wholeStore":                       
                                    $('#cartChoiceOut').attr('selected', true);
                                  break;
                                case "groups":                       
                                    $('#groupChoiceOut').attr('selected', true);
                                  break;                               
                                case "vargroup":                       
                                    $('#varChoiceOut').attr('selected', true);
                                  break;                                
                                case "single":                       
                                    $('#singleChoiceOut').attr('selected', true);
                                  break;                                                                                                                                                                       
                             };
                          };
                          ...
                          switch( $("#rule-on-off-sw-select").val() ) {                                
                            case "on": 
                                ...
                                if ($("#firstTimeBackFromServer").val() != 'yes') {   
                                   ...
                                   jQuery('#buy-group-filter-select').css('color', '#0077BB !important').css('opacity', '1.0').css('filter', 'alpha(opacity=100)');
                                   //only enable the group filter select IF the pricing type warrants it
                                    jQuery('#get-group-filter-select').css('color', '#0077BB !important').css('opacity', '1.0').css('filter', 'alpha(opacity=100)');
                                    switch( $("#pricing-type-select").val() ) {
                                     case "all":
                                     case "simple":
                                        $('#get-group-filter-select').attr("disabled", "disabled");
                            ...
                            case "off": 
                                ...
                                jQuery('#lower-screen-wrapper').css('opacity', '0.5').css('filter', 'alpha(opacity=50)');
                                   ...
                                   jQuery('#buy-group-filter-select').css('color', '#999999 !important').css('opacity', '0.65').css('filter', 'alpha(opacity=65)');
                                   jQuery('#get-group-filter-select').css('color', '#999999 !important').css('opacity', '0.65').css('filter', 'alpha(opacity=65)');                                 
                              break;                                                         
                          };
                        };    
             //*************************************
                     ...
                     //don't do this twice...           hideRemainderOfAllBoxes();
                           ...
                           //   jQuery('#discount_lifetime_max_amt_type_currency_0').css('color', 'black');
                            ...
                            function resetAllSelections() {
                              ...
                              $('#discount_amt_type_title_0').attr('selected', true); 
                              $('#discount_applies_to_each_0').attr('selected', true);
                              //$('#').attr('selected', true);
                              $('#discount_rule_max_amt_type_0').prop('selectedIndex',0);
                              $('#discount_lifetime_max_amt_type_0').prop('selectedIndex',0);
                              $('#cumulativeRulePricing').prop('selectedIndex',0);
                              $('#cumulativeSalePricing').prop('selectedIndex',0);
                              $('#cumulativeCouponPricing').prop('selectedIndex',0);
                              $('#discount_rule_cum_max_amt_type_0').prop('selectedIndex',0);
                          ...
                          //    $("#priority_num").hide();   Handled elsewhere
                            ...
                            function discountAmtType_protect1() {
                              $('.discount_amt_type_title').attr('disabled', false); 
                              if ($("#templateChanged").val() == 'yes') {
                                $('.discount_amt_type_title').attr('selected', true);
                              };
                            ...
                            function discountAmtType_protect2() {
                              $('.discount_amt_type_title').attr('disabled', true);
                            ...
                            function setCumulativeSwitchesYes() {
                              ...
                              if ($("#upperSelectsHaveDataFirstTime").val() == 0 ) {
                                ...
                                $("#cumulativeSalePricing").val('addToSalePrice');
                                $("#ruleApplicationPriority_num").val('10');
                              }
                            ...
                            $('#buy_amt_type_0').change(function(){
                             ...
                             function buy_amt_line_remainder_chg() {     
                              switch( $("#buy_amt_type_0").val() ) {                                
                                case "none":         $("#buy_amt_line_remainder_0").hide("slow");                                                   
                                case "one":          $("#buy_amt_line_remainder_0").hide("slow");  
                                                     break;
                                case "quantity":     $("#buy_amt_line_remainder_0").show("slow");
                                                     $(".buy_amt_count_literal_0").hide("slow"); 
                                                     $("#buy_amt_count_literal_quantity_0").show("slow");   
                                                     break;
                                case "currency":     $("#buy_amt_line_remainder_0").show("slow");
                                                     $(".buy_amt_count_literal_0").hide("slow"); 
                                                     $("#buy_amt_count_literal_currency_0").show("slow");   
                                                     break;
                                case "nthQuantity":  $("#buy_amt_line_remainder_0").show("slow");
                                                     $(".buy_amt_count_literal_0").hide("slow"); 
                            ...
                            $('#action_amt_type_0').change(function(){
                             ...
                             function action_amt_line_remainder_chg() {     
                              switch( $("#action_amt_type_0").val() ) {                                
                                case "none":         $("#action_amt_line_remainder_0").hide("slow");  
                                                      action_amt_subBoxes_test();  break;
                                case "zero":         $("#action_amt_line_remainder_0").hide("slow");  
                                                     action_amt_subBoxes_test();  break;                                                               
                                case "one":          $("#action_amt_line_remainder_0").hide("slow");  
                                                     action_amt_subBoxes_test();  break;
                                case "quantity":     $("#action_amt_line_remainder_0").show("slow");
                                                     $(".action_amt_count_literal_0").hide("slow"); 
                                                     $("#action_amt_count_literal_quantity_0").show("slow");   
                                                     action_amt_subBoxes_test();  break;
                                case "currency":     $("#action_amt_line_remainder_0").show("slow");
                                                     $(".action_amt_count_literal_0").hide("slow"); 
                                                     $("#action_amt_count_literal_currency_0").show("slow");   
                                                     action_amt_subBoxes_test();  break;
                                case "nthQuantity":  $("#action_amt_line_remainder_0").show("slow");
                                                     $(".action_amt_count_literal_0").hide("slow"); 
     ...
     //end old stuff
            ...
            //********************************************                                                                  
                        ...
                        $('#buy-group-filter-select').change(function(){     //if UPPPER select changes, do this also...
                            popChoiceInTest();
                        });
                        ...
                        //mirror popchoice changes to the UPPER select as well
                        function mirrorPopChoiceInChange() { 
                          switch( $("#popChoiceIn").val() ) {
                            case "wholeStore":  $('#buy-group-filter-All').attr('selected', true);       break;
                            case "groups":      $('#buy-group-filter-Group').attr('selected', true);     break;
                            case "vargroup":    $('#buy-group-filter-Vargroup').attr('selected', true);  break;
                            case "single":      $('#buy-group-filter-Single').attr('selected', true);    break;                            
                          };
                        };
                        ...
                        $('#get-group-filter-select').change(function(){     //if UPPPER select changes, do this also...
                            popChoiceOutTest();
                        });
                        ...
                        //mirror popchoice changes to the UPPER select as well
                        function mirrorPopChoiceOutChange() { 
                          switch( $("#popChoiceOut").val() ) {
                            case "sameAsInPop":  $('#get-group-filter-SameAsBuy').attr('selected', true); break;
                            case "wholeStore":   $('#get-group-filter-All').attr('selected', true);       break;
                            case "groups":       $('#get-group-filter-Group').attr('selected', true);     break;
                            case "vargroup":     $('#get-group-filter-Vargroup').attr('selected', true);  break;
                            case "single":       $('#get-group-filter-Single').attr('selected', true);    break;                            
                          };
                        };
