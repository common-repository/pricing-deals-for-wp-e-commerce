...
class VTPRD_Rules_UI{ 
  ...
  public function vtprd_enqueue_admin_scripts() {
    ...
    if( $post_type == 'vtprd-rule' ){ 
        ...
        wp_enqueue_script('vtprd-admin-script');
    ...
    if( $post_type == $vtprd_info['parent_plugin_cpt']){
      ...
      wp_enqueue_script('vtprd-admin-product-metabox-script');    
    }
  }    
  ...
  public function vtprd_error_messages() {     
     ...
     if ( sizeof($vtprd_rule->rule_error_red_fields) > 0 )  {
       ...
       echo '{color:red; display:block; float:left; margin: 0 5px;}' ;         // display:block added for hidden date err msg fields
       echo '</style>' ;
     }
...
************************************************************** */                                                   
  public function vtprd_deal() {     
      global $vtprd_rule_template_framework, $vtprd_deal_structure_framework, $vtprd_deal_screen_framework, $vtprd_rule_display_framework, $vtprd_rule, $vtprd_setup_options;
    ...
    <img id="pricing-deals-img-preload" alt="" src="<?php echo VTPRD_URL;?>/admin/images/upgrade-bkgrnd-banner.jpg" />
      ...
      <div class="display-virtual_box  top-box">                           
        ...
        <input type="hidden" id="fullMsg" name="fullMsg" value="<?php _e('Full theme message required', 'vtprd');?>" >    
        <input type="hidden" id="shortMsg" name="shortMsg" value="<?php _e('Short checkout message required', 'vtprd');?>" > 
        ...
        <div class="template-area clear-left">  
          ...
          <div class="clear-left" id="first-blue-line">                          
            ...
            <span class="blue-dropdown">                              
               <label for="<?php echo $vtprd_rule_display_framework['cart_or_catalog_select']['label']['for'];?>"><?php echo $vtprd_rule_display_framework['cart_or_catalog_select']['label']['title'];?></label>
            ...
            <span class="blue-dropdown">                              
               <label for="<?php echo $vtprd_rule_display_framework['pricing_type_select']['label']['for'];?>"><?php echo $vtprd_rule_display_framework['pricing_type_select']['label']['title'];?></label>
            ...
            <span class="blue-dropdown blue-dropdown-minimum">                              
               <label for="<?php echo $vtprd_rule_display_framework['minimum_purchase_select']['label']['for'];?>"><?php echo $vtprd_rule_display_framework['minimum_purchase_select']['label']['title'];?></label>
          ...
          <div class="clear-left" id="second-blue-line">          
            
            <span class="blue-dropdown">                              
               <label id="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['label']['id'];?>" for="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['label']['for'];?>"><?php echo $vtprd_rule_display_framework['buy_group_filter_select']['label']['title'];?></label>
               <select id="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['select']['id'];?>" class="<?php echo$vtprd_rule_display_framework['buy_group_filter_select']['select']['class']; ?>" name="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['select']['name'];?>" tabindex="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['select']['tabindex']; ?>" >          
                 <?php
                 ...
                 ?>                             
                    <option id="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['option'][$i]['id']; ?>"  class="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['option'][$i]['class']; ?>"  value="<?php echo $vtprd_rule_display_framework['buy_group_filter_select']['option'][$i]['value']; ?>"   <?php if ($vtprd_rule_display_framework['buy_group_filter_select']['option'][$i]['value'] == $vtprd_rule->buy_group_filter_select )  { echo $selected; } ?> >  <?php echo $title ?> </option>
                 <?php } ?> 
               </select>                                      
            </span> 
                                                 
            <span class="blue-dropdown">                              
               <label id="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['label']['id'];?>" for="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['label']['for'];?>"><?php echo $vtprd_rule_display_framework['get_group_filter_select']['label']['title'];?></label>
               <select id="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['select']['id'];?>" class="<?php echo$vtprd_rule_display_framework['get_group_filter_select']['select']['class']; ?>" name="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['select']['name'];?>" tabindex="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['select']['tabindex']; ?>" >          
                 <?php
                 for($i=0; $i < sizeof($vtprd_rule_display_framework['get_group_filter_select']['option']); $i++) { 
                      
                      //pick up the free/pro version of the title => in this case, title and title3
                      $title = $vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['title'];
                      if ( ( defined('VTPRD_PRO_DIRNAME') ) &&
                           ( $vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['title3'] > ' ' ) ) {
                        $title = $vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['title3'];                        
                      }                 
                 ?>                             
                    <option id="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['id']; ?>"  class="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['class']; ?>"  value="<?php echo $vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['value']; ?>"   <?php if ($vtprd_rule_display_framework['get_group_filter_select']['option'][$i]['value'] == $vtprd_rule->get_group_filter_select )  { echo $selected; } ?> >  <?php echo $title; ?> </option>
                 <?php } ?> 
               </select>                          
            </span>   
                   
          </div> <?php //end second-blue-line ?> 
                   
          <div class="clear-left" id="third-blue-line"> 
            <span class="blue-dropdown scheduling-group">                                        
                <label class="scheduling-label"><?php _e('Schedule', 'vtprd');?></label>   
               ...
               <?php //   <label class="scheduling-label">Scheduling</label> ?>                                              
                  ...
                  <?php //     <label for="rule-state-select">On/Off Switch</label>  ?> 
                     <select id="<?php echo $vtprd_rule_display_framework['rule_on_off_sw_select']['select']['id'];?>" class="<?php echo$vtprd_rule_display_framework['rule_on_off_sw_select']['select']['class']; ?>" name="<?php echo $vtprd_rule_display_framework['rule_on_off_sw_select']['select']['name'];?>" tabindex="<?php echo $vtprd_rule_display_framework['rule_on_off_sw_select']['select']['tabindex']; ?>" >          
                      ...
                      <a id="deal-type-title-more" class="more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
                      <a id="deal-type-title-less" class="more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...&nbsp;&nbsp;', 'vtprd'); ?><img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>
                                                          
  
   
                    <?php vtprd_show_help_selection_panel_A('0'); ?>
                  </div> <?php //end third-blue-line ?>
          ...
          <a id="pricing-deal-title-more" class="more-anchor  clear-both" href="javascript:void(0);"><?php _e(' Help! Tell Me About Pricing Deals ', 'vtprd');?><img class="plus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>            
          <a id="pricing-deal-title-less" class="more-anchor less-anchor clear-both" href="javascript:void(0);"><?php _e('   Less Pricing Deals Help ...', 'vtprd'); ?><img class="minus-button" alt="help" height="14px" width="14px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>              
          <?php //Help Panel for PRICING DEAL SELECTION whole box, controlled in metaBox_title area above    
             vtprd_show_help_selection_panel_0();  ?>                 
     
  <div class="display-virtual_box hideMe" id="lower-screen-wrapper" >


                      <a id="pricing-deal-examples-more" class="more-anchor hideMe" href="javascript:void(0);"><img class="pricing-deal-examples-helpPng" alt="help"  width="14" height="14" src="<?php echo VTPRD_URL;?>/admin/images/help.png" /><?php _e(' Pricing Deal Examples ', 'vtprd'); ?><img class="plus-button" alt="help" height="14px" width="14px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>            
                      <a id="pricing-deal-examples-less" class="more-anchor less-anchor hideMe" href="javascript:void(0);"><img class="pricing-deal-examples-helpPng" alt="help" width="14" height="14" src="<?php echo VTPRD_URL;?>/admin/images/help.png" /><?php _e('   Less Examples ...', 'vtprd'); ?><img class="minus-button" alt="help" height="14px" width="14px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>              
 
                    <div class="selection-panel-wrapper hideMe">  <?php //wrapper needed to uniquely address the in-panel dropdown triggers ?> 
     ...
     <div class="display-virtual_box  clear-left" id="rule_deal_info_group">  
      ...
      <div class="display-virtual_box rule_deal_info" id="rule_deal_info_line<?php echo '_' .$k; ?>">   
        <div class="display-virtual_box" id="buy_info<?php echo '_' .$k; ?>">  
         ...
         <div class="screen-box buy_group_title_box">
            <span class="buy_group_title-area">
              ...
              <span class="section-headings first-level-title showBuyAsDiscount" id="buy_group_title_asDiscount">
                <?php _e('Buy Group ', 'vtprd');?><span class="label-no-cap">&nbsp;&nbsp;<?php _e('(Discount Group)', 'vtprd');?></span>
              </span>
         ...
         <div class="screen-box buy_amt_box  buy_amt_box_class<?php echo '_' .$k; ?>" id="buy_amt_box<?php echo '_' .$k; ?>" >
            <span class="title" id="buy_amt_title<?php echo '_' .$k; ?> ">
              <a id="buy_amt_title_anchor<?php echo '_' .$k; ?>" class="title-anchors second-level-title" href="javascript:void(0);"><span class="showBuyAsBuy"><?php _e('Buy Group Amount:', 'vtprd');?></span><span class="showBuyAsDiscount"><?php _e('Discount Group Amount:', 'vtprd');?></span></a>
            </span>                                                
            <?php vtprd_show_help_tooltip($context = 'buy-amt-title', $location = 'title'); ?>              
            <span class="shortIntro buyShortIntro" ><?php echo __(' ...  "BUY 5 / ', 'vtprd') .$currency_symbol. __('500"...', 'vtprd');?></span>             
            <a id="buy-amt-title-more<?php echo '-' .$k; ?>" class="buy-amt-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></span></a>
            <a id="buy-amt-title-less<?php echo '-' .$k; ?>" class="buy-amt-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...&nbsp;&nbsp;', 'vtprd'); ?><img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>
                            
 
            <span class="dropdown buy_amt clear-left" id="buy_amt_dropdown<?php echo '_' .$k; ?>">              
               <select id="<?php echo $vtprd_deal_screen_framework['buy_amt_type']['select']['id'] . '_' .$k ; ?>" class="<?php echo$vtprd_deal_screen_framework['buy_amt_type']['select']['class']; ?>" name="<?php echo $vtprd_deal_screen_framework['buy_amt_type']['select']['name'] . '_' .$k ; ?>" tabindex="<?php echo $vtprd_deal_screen_framework['buy_amt_type']['select']['tabindex']; ?>" >          
                 ...
                 <span class="buy_amt_line_remainder  buy_amt_line_remainder_class<?php echo '_' .$k; ?>" id="buy_amt_line_remainder<?php echo '_' .$k; ?>">   
                     <span class="amt-field buy_amt_count" id="buy_amt_count_area<?php echo '_' .$k; ?>">
                       <span class="amt-field-label" id="buy_amt_count_label<?php echo '_' .$k; ?>"> 
                          <span class="buy_amt_count_literal  buy_amt_count_literal<?php echo '_' .$k;?> " id="buy_amt_count_literal_quantity<?php echo '_' .$k; ?>"><?php _e('Qty: ', 'vtprd');?> </span>                          
                          <span class="buy_amt_count_literal  buy_amt_count_literal<?php echo '_' .$k;?> " id="buy_amt_count_literal_currency<?php echo '_' .$k; ?>"><?php echo $currency_symbol . ':'; ?> </span>
                          <span class="buy_amt_count_literal  buy_amt_count_literal<?php echo '_' .$k;?> " id="buy_amt_count_literal_nthQuantity<?php echo '_' .$k; ?>"><?php _e('Nth (number): ', 'vtprd');?> </span> 
                       </span>
                     ...
                     <span class="dropdown-label" id="buy_amt_applies_to_label<?php echo '_' .$k; ?>">
                        <?php vtprd_show_help_tooltip($context = 'buy-amt-applies-to', $location = 'title'); ?>
                        <?php _e('Applies To: ', 'vtprd');?> 
                     </span>                 
                     <select id="<?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['select']['id'] . '_' .$k ; ?>" class="<?php echo$vtprd_deal_screen_framework['buy_amt_applies_to']['select']['class']; ?>" name="<?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['select']['name'] . '_' .$k ; ?>" tabindex="<?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['select']['tabindex']; ?>" >          
                       ...
                       ?>                             
                          <option id="<?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['option'][$i]['id'] . '_' .$k; //. '_'  .$k . '_' .$i; ?>"  class="<?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['option'][$i]['class']; ?>"  value="<?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['option'][$i]['value']; ?>"   <?php if ($vtprd_deal_screen_framework['buy_amt_applies_to']['option'][$i]['value'] == $vtprd_rule->rule_deal_info[$k]['buy_amt_applies_to'] )  { echo $selected; } ?> >  <?php echo $vtprd_deal_screen_framework['buy_amt_applies_to']['option'][$i]['title']; ?> </option>
                       <?php } ?> 
                     </select> 
                 </span>               
            </span>
            <?php vtprd_show_help_selection_panel_B($k); ?>
            <?php vtprd_show_help_selection_panel_C($k); ?>
         </div>
         ...
         <div class="screen-box buy_amt_mod_box  buy_amt_mod_box_class<?php echo '_' .$k; ?>" id="buy_amt_mod_box<?php echo '_' .$k; ?>" > 
            <span class="title third-level-title" id="buy_amt_mod_title<?php echo '_' .$k; ?>" >
              <a id="buy_amt_mod_title_anchor<?php echo '_' .$k; ?>" class="title-anchors third-level-title" href="javascript:void(0);"><span class="showBuyAsBuy"><?php _e('Buy Group Min/Max:', 'vtprd');?></span><span class="showBuyAsDiscount"><?php _e('Discount Group Min/Max:', 'vtprd');?></span></a> 
            </span>
              <?php vtprd_show_help_tooltip($context = 'buy_amt_mod_title', $location = 'title'); ?> 
            <span class="shortIntro buyShortIntro" ><?php echo __(' ...  "Buy 5 units FOR A MINIMUM OF ', 'vtprd') .$currency_symbol.  __('300, Get"...', 'vtprd');?></span>           
            <span class="dropdown buy_amt_mod clear-left" id="buy_amt_mod_dropdown<?php echo '_' .$k; ?>">              
               ...
               <span class="amt-field  buy_amt_mod_count_area  buy_amt_mod_count_area_class<?php echo '_' .$k; ?>" id="buy_amt_mod_count_area<?php echo '_' .$k; ?>">
                 <span class="amt-field-label" id="buy_amt_mod_count_label<?php echo '_' .$k; ?>"> <?php echo $currency_symbol . ':'; ?> </span> 
         ...
         <div class="screen-box buy_group_box_class" id="buy_group_box" >
            <span class="title" id="buy_group_title">
              <a id="buy_group_title_anchor" class="title-anchors second-level-title" href="javascript:void(0);"><span class="showBuyAsBuy"><?php _e('Buy Group Filter:', 'vtprd');?></span><span class="showBuyAsDiscount"><?php _e('Discount Group Filter:', 'vtprd');?></span> </a>  
            </span>
            <?php vtprd_show_help_tooltip($context = 'buy-group-title', $location = 'title'); ?>  
            <span class="shortIntro buyShortIntro" ><?php echo __(' ...  "BUY 5 Items.. Filtered By Category / Logged-in Status / Customer Category" ...', 'vtprd');?></span>           
            <span class="dropdown buy_group clear-left" id="buy_group_dropdown">              
            ...
            <?php //vtprd_show_help_selection_panel_X(); ?>
         </div>
          ...
          <div class="screen-box buy_repeat_box  buy_repeat_box_class<?php echo '_' .$k; ?>" id="buy_repeat_box<?php echo '_' .$k; ?>" >     <?php //Rule repeat shifted to end of action area, although processed first ?> 
            <span class="title third-level-title" id="buy_repeat_title<?php echo '_' .$k; ?> ">
               <a id="buy_repeat_title_anchor<?php echo '_' .$k; ?>" class="title-anchors third-level-title" href="javascript:void(0);"><span class="showBuyAsBuy"><?php echo __('Rule Repeat', 'vtprd') .'&nbsp;&nbsp;&nbsp;'.  __(' (buy group repeat):', 'vtprd');?></span><span class="showBuyAsDiscount"><?php echo __('Rule Repeat', 'vtprd') .'&nbsp;&nbsp;&nbsp;'.  __(' (discount group repeat):', 'vtprd');?></span></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'buy_repeat_condition_title', $location = 'title'); ?> 
            <span class="shortIntro buyShortIntro" ><?php echo __(' ...  "FOR EACH TIME you buy 5 / ', 'vtprd') .$currency_symbol.  __('500', 'vtprd') .'&nbsp;&nbsp;&nbsp;'.  __('(in this cart)"...', 'vtprd'); ?></span>           
            <span class="dropdown buy_repeat clear-left" id="buy_repeat_dropdown<?php echo '_' .$k; ?>">              
               ...
               <span class="amt-field  buy_repeat_count_area  buy_repeat_count_area_class<?php echo '_' .$k; ?>" id="buy_repeat_count_area<?php echo '_' .$k; ?>">
                    <?php vtprd_show_help_tooltip($context = 'buy_repeat_condition_title'); ?>                 
                 <span class="amt-field-label" id="buy_repeat_count_label<?php echo '_' .$k; ?>"> 
                    <?php _e('Count: ', 'vtprd');?> 
                  </span>
        ...
        </div> <?php //end  buy_info display-virtual_box ?>
        ...
        <div class="display-virtual_box action_info" id="action_info<?php echo '_' .$k; ?>"> 
         ...
         <div class="screen-box get_group_title_box">
            <span class="get_group_title-area">
              ...
              <span class="section-headings first-level-title showGetAsDiscount" id="get_group_title_active">
                <?php _e('Get Group ', 'vtprd');?><span class="label-no-cap">&nbsp;&nbsp;<?php _e('(Discount Group)', 'vtprd');?></span>
              </span>
         ...
         <div class="screen-box action_amt_box  action_amt_box_class<?php echo '_' .$k; ?>" id="action_amt_box<?php echo '_' .$k; ?>" > 
            <span class="title" id="action_amt_type_title<?php echo '_' .$k; ?>" >            
              <a id="action_amt_title_anchor<?php echo '_' .$k; ?>" class="title-anchors second-level-title" href="javascript:void(0);"><span class="showGetAsGet"><?php _e('Get Group Amount:', 'vtprd');?></span><span class="showGetAsDiscount"><?php _e('Discount Group Amount:', 'vtprd');?></span></a>
            </span>            
             <?php vtprd_show_help_tooltip($context = 'action_amt_title', $location = 'title'); ?>
             <span class="shortIntro" ><?php _e(' ...  "Buy a laptop, GET ONE mouse free "...', 'vtprd');?></span> 
              <a id="action-amt-title-more<?php echo '-' .$k; ?>" class="action-amt-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
              <a id="action-amt-title-less<?php echo '-' .$k; ?>" class="action-amt-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e(' ', 'vtprd'); ?> Less ...&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>                        
            <span class="dropdown action_amt clear-left" id="action_amt_dropdown<?php echo '_' .$k; ?>">              
               ...
               <span class="action_amt_line_remainder  action_amt_line_remainder_class<?php echo '_' .$k; ?>" id="action_amt_line_remainder<?php echo '_' .$k; ?>">
                   <span class="amt-field action_amt_count" id="action_amt_count_pair<?php echo '_' .$k; ?>">
                     <span class="amt-field-label" id="action_amt_count_label<?php echo '_' .$k; ?>"> 
                          <span class="action_amt_count_literal  action_amt_count_literal<?php echo '_' .$k;?> " id="action_amt_count_literal_quantity<?php echo '_' .$k; ?>"><?php _e('Qty: ', 'vtprd');?> </span>
                          <span class="action_amt_count_literal  action_amt_count_literal<?php echo '_' .$k;?> " id="action_amt_count_literal_percent<?php echo '_' .$k; ?>"><?php _e('%: ', 'vtprd');?> </span>
                          <span class="action_amt_count_literal  action_amt_count_literal<?php echo '_' .$k;?> " id="action_amt_count_literal_currency<?php echo '_' .$k; ?>"><?php echo $currency_symbol . ':'; ?> </span>
                          <span class="action_amt_count_literal  action_amt_count_literal<?php echo '_' .$k;?> " id="action_amt_count_literal_nthQuantity<?php echo '_' .$k; ?>"><?php _e('Nth (number): ', 'vtprd');?> </span> 
                       </span>
                   ...
                   <span class="dropdown-label" id="action_amt_applies_to_label<?php echo '_' .$k; ?>">
                      <?php vtprd_show_help_tooltip($context = 'get-amt-applies-to', $location = 'title'); ?>
                      <?php _e('Amount Applies To: ', 'vtprd');?> 
                   </span>               
          ...
          <?php vtprd_show_help_selection_panel_D($k); ?>
          <?php vtprd_show_help_selection_panel_E($k); ?>
        </div>
        ...
        <div class="screen-box action_amt_mod_box  action_amt_mod_box_class<?php echo '_' .$k; ?>" id="action_amt_mod_box<?php echo '_' .$k; ?>" >
            <span class="title third-level-title" id="action_amt_mod_title<?php echo '_' .$k; ?>" >
               <a id="action_amt_mod_title_anchor<?php echo '_' .$k; ?>" class="title-anchors third-level-title" href="javascript:void(0);"><span class="showGetAsGet"><?php _e('Get Group Min/Max:', 'vtprd');?></span><span class="showGetAsDiscount"><?php _e('Discount Group Min/Max:', 'vtprd');?></span></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'action_amt_mod_title', $location = 'title'); ?>
            <span class="shortIntro" ><?php echo __(' ...  "Buy 5 tech items, Get a mouse free WHEN ITEM A MIN/MAX OF ', 'vtprd') .$currency_symbol. __('10 "...', 'vtprd'); ?></span>           
            <span class="dropdown  clear-left" id="action_amt_mod_dropdown<?php echo '_' .$k; ?>">
               ...
               <span class="amt-field  action_amt_mod_count_area  action_amt_mod_count_area_class<?php echo '_' .$k; ?>" id="action_amt_mod_count_area<?php echo '_' .$k; ?>">
                 <span class="amt-field-label" id="action_amt_mod_count_label<?php echo '_' .$k; ?>"> <?php echo $currency_symbol . ':'; ?> </span>
         ...
         <div class="screen-box action_group_box_class" id="action_group_box" >
            <span class="title" id="action_group_title">
              <a id="action_group_title_anchor" class="title-anchors second-level-title" href="javascript:void(0);"><span class="showGetAsGet"><?php _e('Get Group Filter::', 'vtprd');?></span><span class="showGetAsDiscount"><?php _e('Discount Group Filter:', 'vtprd');?></span></a>
            </span>
            <?php vtprd_show_help_tooltip($context = 'action-group-title', $location = 'title'); ?>            
             
            <span class="shortIntro" ><?php echo __(' ...  "Buy 5 .. GET 1 item .. Filtered By Category / Logged-in Status / Customer Category" ...', 'vtprd');?></span>             
            <a id="action-group-title-more" class="action-group-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
            <a id="action-group-title-less" class="action-group-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>
          
            <span class="dropdown action_group clear-left" id="action_group_dropdown_0">              
            ...
            <?php vtprd_show_help_selection_panel_J('0'); ?>
         </div>
         ...
         <div class="screen-box action_repeat_condition_box  action_repeat_condition_box_class<?php echo '_' .$k; ?>" id="action_repeat_condition_box<?php echo '_' .$k; ?>" >      <?php //Action repeat shifted to end of action area, although processed first ?> 
            <span class="title third-level-title" id="action_repeat_condition_title<?php echo '_' .$k; ?>" >
               <a id="action_repeat_condition_title_anchor<?php echo '_' .$k; ?>" class="title-anchors third-level-title" href="javascript:void(0);"><span class="showGetAsGet"><?php _e('Get Group Repeat:', 'vtprd');?></span><span class="showGetAsDiscount"><?php _e('Discount Group Repeat:', 'vtprd');?></span></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'action_repeat_condition_title', $location = 'title'); ?>
            <span class="shortIntro" ><?php echo __(' ...  "Buy 5 units get next one free, ONLY ONCE"...', 'vtprd') .'&nbsp;&nbsp;&nbsp;'.  __('(in this cart)"...', 'vtprd'); ;?></span>           
            <span class="dropdown action_repeat_condition clear-left"  id="action_repeat_condition_dropdown<?php echo '_' .$k; ?>">              
               ...
               <span class="amt-field action_repeat_count_area  action_repeat_count_area_class<?php echo '_' .$k; ?>" id="action_repeat_count_area<?php echo '_' .$k; ?>">
                 <?php vtprd_show_help_tooltip($context = 'action_repeat_condition_title'); ?>
                 <span class="amt-field-label" id="action_repeat_count_label<?php echo '_' .$k; ?>">                     
                    <?php _e('Count: ', 'vtprd');?> 
                 </span>
      ...
      </div> <?php //end  get_info display-virtual_box ?> 
        ...
        <div class="display-virtual_box" id="discount_info">
          ...
          <div class="screen-box discount_amt_box  discount_amt_box_class<?php echo '_' .$k; ?>" id="discount_amt_box<?php echo '_' .$k; ?>" >  
            <span class="title" id="discount_amt_title<?php echo '_' .$k; ?>" >
              ...
              <a id="discount_amt_title_anchor<?php echo '_' .$k; ?>" class="section-headings first-level-title" href="javascript:void(0);"><?php _e('Discount Action:', 'vtprd');?></a>
            </span>
            <span class="title clear-both discount_action_type" id="discount_action_type_title<?php echo '_' .$k; ?>" >            
              <a id="discount_action_title_anchor<?php echo '_' .$k; ?>" class="title-anchors second-level-title" href="javascript:void(0);"><?php _e('Discount Action Type:', 'vtprd');?></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'discount_amt_title', $location = 'title'); ?>
            <span class="shortIntro" ><?php _e(' ...  "Buy 1, get 1 FREE "...', 'vtprd');?></span>               
              <a id="discount-amt-title-more<?php echo '-' .$k; ?>" class="discount-amt-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
              <a id="discount-amt-title-less<?php echo '-' .$k; ?>" class="discount-amt-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>              

            <span class="hide-discount-help">
              <a id="discount-amt-info-more" class="" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Checkout How-to &nbsp;-&nbsp; Discounts Show Automatically ', 'vtprd'); ?>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>            
              <a id="discount-amt-info-less" class="less-anchor" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Less Checkout Discount Display Help ... ', 'vtprd'); ?>&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>                              
            </span>
            <span class="dropdown discount_amt_type clear-left" id="discount_amt_type_dropdown<?php echo '_' .$k; ?>">              
               ...
               <span class="discount_amt_count_area  discount_amt_count_area_class<?php echo '_' .$k; ?>  amt-field" id="discount_amt_count_area<?php echo '_' .$k; ?>">    
                 <span class="amt-field-label" id="discount_amt_count_label<?php echo '_' .$k; ?>"> 
                    <span class="discount_amt_count_literal  discount_amt_count_literal<?php echo '_' .$k;?> " id="discount_amt_count_literal_quantity<?php echo '_' .$k; ?>"><?php _e('Qty: ', 'vtprd');?> </span>
                    <span class="discount_amt_count_literal  discount_amt_count_literal<?php echo '_' .$k;?> " id="discount_amt_count_literal_percent<?php echo '_' .$k; ?>"><?php _e('%: ', 'vtprd');?> </span>
                    <span class="discount_amt_count_literal  discount_amt_count_literal<?php echo '_' .$k;?> " id="discount_amt_count_literal_currency<?php echo '_' .$k; ?>"><?php echo $currency_symbol . ':'; ?> </span>
                    ...
                    <span class="discount_amt_count_literal  discount_amt_count_literal<?php echo '_' .$k;?> " id="discount_amt_count_literal_forThePriceOf<?php echo '_' .$k; ?>"><?php echo '&nbsp;'; _e('For the Price of: ', 'vtprd'); ?> </span>
                    <span class="discount_amt_count_literal  discount_amt_count_literal<?php echo '_' .$k;?> " id="discount_amt_count_literal_forThePriceOf_Currency<?php echo '_' .$k; ?>"><?php echo $currency_symbol; ?></span>
                 </span>                 
                 ...
                 <span class="amt-field  discount_amt_count_literal  discount_amt_count_literal<?php echo '_' .$k;?>  discount_amt_count_literal_units_area  discount_amt_count_literal_units_area_class<?php echo '_' .$k; ?>" id="discount_amt_count_literal_units_area<?php echo '_' .$k; ?>">
                   <span class="amt-field-label" id="discount_amt_count_literal_units<?php echo '_' .$k; ?>"><?php _e(' units', 'vtprd');?> </span>
                ...
                <label id="<?php echo $vtprd_deal_screen_framework['discount_auto_add_free_product']['label']['id'] . '_'  .$k; ?>"   class="<?php echo $vtprd_deal_screen_framework['discount_auto_add_free_product']['label']['class'] ?>"> 
                    <input id="<?php echo $vtprd_deal_screen_framework['discount_auto_add_free_product']['checkbox']['id'] . '_'  .$k; ?>" 
                          class="<?php echo $vtprd_deal_screen_framework['discount_auto_add_free_product']['checkbox']['class']; ?>"
                          type="checkbox" 
                ...
                <?php vtprd_show_help_selection_panel_6(); //info about auto-add!!?>
               <span class="hide-discount-help">                
                <a id="discount-msgs-install-more" class="" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Cart Widget How-to ', 'vtprd'); echo '&nbsp;-&nbsp;'; _e(' Show Pricing Deal Discounts', 'vtprd'); ?>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>            
                <a id="discount-msgs-install-less" class="less-anchor" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Less Cart Widget Install Help ... ', 'vtprd'); ?>&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>                                                                        
               </span>
            </span>

            <?php vtprd_show_help_selection_panel_F($k); ?>
            <?php vtprd_show_help_selection_panel_1(); //special how-to panel...?>
          ...
          <div class="screen-box discount_applies_to_box  discount_applies_to_box_class<?php echo '_' .$k; ?>" id="discount_applies_to_box<?php echo '_' .$k; ?>" >
            <span class="title" id="discount_applies_to_title<?php echo '_' .$k; ?>" >
              <a id="discount_applies_to_title_anchor<?php echo '_' .$k; ?>" class="title-anchors second-level-title" href="javascript:void(0);"><?php _e('Discount Action Applies To:', 'vtprd');?></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'discount_applies_to', $location = 'title'); ?>
            <span class="shortIntro" ><?php _e(' ...  "Discount applies to: EACH ITEM singly / the WHOLE GROUP as a UNIT"...', 'vtprd');?></span>
              <a id="discount-applies-to-title-more<?php echo '-' .$k; ?>" class="discount-applies-to-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
              <a id="discount-applies-to-title-less<?php echo '-' .$k; ?>" class="discount-applies-to-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>               
                       
            <span class="dropdown discount_applies_to clear-left"  id="discount_applies_to_dropdown<?php echo '_' .$k; ?>">              
            ...
            <?php vtprd_show_help_selection_panel_G($k); ?>  
          </div>
          
        
          <div class="screen-box discount_lifetime_max_amt_type clear-left" id="discount_lifetime_max_amt_type_box">  
             <?php
                 /* ***********************
            ...
            <span class="title" id="discount_lifetime_max_title_0" >
              <a id="discount_lifetime_max_title_anchor" class="title-anchors second-level-title" href="javascript:void(0);"><?php _e('Per Customer Limit:', 'vtprd');?></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'discount_lifetime_max_amt_type', $location = 'title'); ?>
            <span class="shortIntro" ><?php echo __(' ... "ONE DISCOUNT PER CUSTOMER ...', 'vtprd'); ?></span>
              <a id="discount-lifetime-max-title-more-0" class="discount-lifetime-max-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
              <a id="discount-lifetime-max-title-less-0" class="discount-lifetime-max-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>              
                       
            <span class="dropdown  clear-left" id="discount_lifetime_max_dropdown">
               ...
               <span class="amt-field" id="discount_lifetime_max_amt_count_area">
                  <span class="amt-field-label" id="discount_lifetime_max_amt_count_label_0">
                      <span class="discount_lifetime_max_amt_count_literal" id="discount_lifetime_max_amt_count_literal_quantity"><?php _e('Count: ', 'vtprd');?> </span>                         
                      <span class="discount_lifetime_max_amt_count_literal" id="discount_lifetime_max_amt_count_literal_currency"><?php echo $currency_symbol . ':'; ?> </span>                                                                                  
                  </span>
                 <input id="<?php echo $vtprd_deal_screen_framework['discount_lifetime_max_amt_count']['id'] .'_0' ?>" class="<?php echo $vtprd_deal_screen_framework['discount_lifetime_max_amt_count']['class']; ?>" type="<?php echo $vtprd_deal_screen_framework['discount_lifetime_max_amt_count']['type']; ?>" name="<?php echo $vtprd_deal_screen_framework['discount_lifetime_max_amt_count']['name'] .'_0' ;?>" value="<?php echo $vtprd_rule->rule_deal_info[0]['discount_lifetime_max_amt_count']; // use '0' deal_info_line...?>">
               </span>
            </span>
             <?php vtprd_show_help_selection_panel_I('0'); ?>
      ...
      <?php //****************  
            //end  DISCOUNT INFO  display-virtual_box 
            //**************** ?>   
        
        </div> <?php //end DEAL INFO line in "for" loop ?>   
      <?php } ?>
      </div> <?php //end rule_deal_info_group ?>  
      ...
      <div id="messages-outer-box">           
         <div class="screen-box  messages-box_class" id="messages-box">
           <span class="title" id="discount_msgs_title" >
              ...
              <a id="discount_msgs_title_anchor" class="section-headings first-level-title" href="javascript:void(0);"><?php _e('Theme and Checkout Messages:', 'vtprd');?></a>            
           </span>
           <a id="discount-shortcodes-more" class="" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Add Messages to your Theme using Shortcodes!', 'vtprd'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>            
           <a id="discount-shortcodes-less" class="less-anchor" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Less Shortcodes Help ... ', 'vtprd'); ?>&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>
           <span class="dropdown messages-box-area clear-left"  id="discount_msgs_dropdown">
             <span class="discount_product_full_msg_area clear-both">
               <span class="text-field" id="discount_product_full_msg_line">
                 <span class="text-field-label" id="discount_product_full_msg_label"> <?php _e('Discount Theme Message: ', 'vtprd');?> </span>
                 <?php vtprd_show_help_tooltip($context = 'discount_full_msg'); ?>
                  <a id="discount-msgs-info-more" class="" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Add "You Save" and "Old Price" Realtime Rule Info ', 'vtprd'); ?>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>            
                  <a id="discount-msgs-info-less" class="less-anchor" href="javascript:void(0);"><img width="10" height="10" src="<?php echo VTPRD_URL;?>/admin/images/help.png" alt="help"><?php _e(' Less Realtime Messages Use Help ... ', 'vtprd'); ?>&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>                                
                 <textarea rows="1" cols="100" id="<?php echo $vtprd_rule_display_framework['discount_product_full_msg']['id']; ?>" class="<?php echo $vtprd_rule_display_framework['discount_product_full_msg']['class']; ?>" type="<?php echo $vtprd_rule_display_framework['discount_product_full_msg']['type']; ?>" name="<?php echo $vtprd_rule_display_framework['discount_product_full_msg']['name']; ?>" ><?php echo $vtprd_rule->discount_product_full_msg; ?></textarea> 
               </span>                                                                                                               
             </span>
             <span class="discount_product_short_msg_area  clear-left">
               <span class="text-field" id="discount_product_short_msg_line">
                 <span class="text-field-label" id="discount_product_short_msg_label"> <?php _e('Discount Checkout Message (short): ', 'vtprd');?> </span>
                 <?php vtprd_show_help_tooltip($context = 'discount_short_msg'); ?>
                 <textarea rows="1" cols="60" id="<?php echo $vtprd_rule_display_framework['discount_product_short_msg']['id']; ?>" class="<?php echo $vtprd_rule_display_framework['discount_product_short_msg']['class']; ?>" type="<?php echo $vtprd_rule_display_framework['discount_product_short_msg']['type']; ?>" name="<?php echo $vtprd_rule_display_framework['discount_product_short_msg']['name']; ?>" ><?php echo $vtprd_rule->discount_product_short_msg; ?></textarea>
               </span>
             </span> 
           </span>
      ...
      <span class="box-border-line">&nbsp;</span>
      <span class="title advanced-area">
        <img class="advanced_area_icon" src="<?php echo VTPRD_URL;?>/admin/images/tab-icons.png" width="1" height="1" />                                                        
        <span id="advanced-title"><?php _e('ADVANCED AREA', 'vtprd');?></span><span id="advanced-subtitle"><?php _e('(optional)', 'vtprd');?></span>
      </span>       
    ...
    <div id="advanced-data-area"> 
      <div class="screen-box" id="cumulativePricing_box">     
          <span class="title" id="cumulativePricing_title" >
            ...
            <a id="cumulativePricing_title_anchor" class="section-headings first-level-title" href="javascript:void(0);"><?php _e('Discounts Working Together:', 'vtprd');?></a>
          </span>
            <?php vtprd_show_help_tooltip($context = 'cumulative_pricing_switches', $location = 'title'); ?>
          <span class="shortIntro" ><?php _e(' ... CONTROL MULTIPLE DISCOUNTS being applied at the same time ...', 'vtprd');?></span>           
          <div class="clear-left" id="cumulativePricing_dropdown">       
            <div class="dropdown cumulativeRulePricing_area clear-left" id="cumulativeRulePricing_areaID"> 
               <span class="text-field-label cumulativeRulePricing_lit" id="cumulativeRulePricing_label"><?php _e('Apply this Rule Discount ', 'vtprd'); echo '&nbsp;&nbsp;';  _e('in Addition to Other Cart Rule Discounts : &nbsp;', 'vtprd');?></span>               
               ...
               <?php vtprd_show_help_tooltip($context = 'cumulativeRulePricing'); ?>
               <span class="" id="priority_num">   <?php //only display if multiple rule discounts  ?>
                 <span class="text-field" id="ruleApplicationPriority_num">
                   <span class="text-field-label" id="ruleApplicationPriority_num_label"> <?php _e('Rule Priority Sort Number:', 'vtprd');?> </span>
                 ...
                 <?php vtprd_show_help_tooltip($context = 'ruleApplicationPriority_num'); ?>
               </span>             
            </div>
    
            <div class="dropdown cumulativeCouponPricing_area clear-left" id="cumulativeCouponPricing_0">              
               <span class="text-field-label cumulativeRulePricing_lit" id="cumulativeCouponPricing_label"><?php _e('Apply this Rule Discount ', 'vtprd'); echo '&nbsp;&nbsp;';  _e('in Addition to Coupon Discount : &nbsp;', 'vtprd');?></span>               
               ...
               <?php vtprd_show_help_tooltip($context = 'cumulativeCouponPricing'); ?> 
            </div>
                 
            <div class="dropdown cumulativeSalePricing_area clear-left" id="cumulativeSalePricing_areaID">              
               <span class="text-field-label cumulativeRulePricing_lit" id="cumulativeSalePricing_label"><?php _e('Apply this Rule Discount ', 'vtprd'); echo '&nbsp;&nbsp;';  _e('to Product Sale Pricing : &nbsp;', 'vtprd');?></span> 
               ...
               <?php vtprd_show_help_tooltip($context = 'cumulativeSalePricing'); ?>
            </div>
      ...
      <div class="screen-box" id="maximums_box">   
        ...
        <div class="dropdown discount_rule_max_amt_type clear-left" id="discount_rule_max_amt_type_box">  
             <?php
                 /* ***********************
            ...
            <span class="title" id="discount_rule_max_title_0" >
              <a id="discount_rule_max_title_anchor" class="title-anchors second-level-title" href="javascript:void(0);"><?php _e('Discount Maximum for Rule:', 'vtprd');?></a>
            </span>
              <?php vtprd_show_help_tooltip($context = 'discount_rule_max_amt_type', $location = 'title'); ?>
            <span class="shortIntro" ><?php echo __(' ... "Buy 5 laptops, get a discount, MAX DISCOUNT VALUE OF ', 'vtprd')  .$currency_symbol. __('30"...', 'vtprd'); ?></span>  
              <a id="discount-rule-max-title-more-0" class="discount-rule-max-title-more more-anchor" href="javascript:void(0);"><span class="context-help"><?php _e('Context Help', 'vtprd'); ?></span>&nbsp;<img class="plus-button" alt="help" height="10px" width="10px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
              <a id="discount-rule-max-title-less-0" class="discount-rule-max-title-less more-anchor less-anchor" href="javascript:void(0);"><?php _e('  Less ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>              
                       
            <span class="dropdown clear-left" id="discount_rule_max_dropdown">
                ...
                <span class="amt-field  " id="discount_rule_max_amt_count_area">
                  <span class="amt-field-label" id="discount_rule_max_amt_count_label_0"> 
                      <span class="discount_rule_max_amt_count_literal" id="discount_rule_max_amt_count_literal_quantity"><?php _e('Count: ', 'vtprd');?> </span> 
                      <span class="discount_rule_max_amt_count_literal" id="discount_rule_max_amt_count_literal_percent"><?php echo '%: ';?> </span>                          
                      <span class="discount_rule_max_amt_count_literal" id="discount_rule_max_amt_count_literal_currency"><?php echo $currency_symbol . ':'; ?> </span>                                  
                  </span>
                 <input id="<?php echo $vtprd_deal_screen_framework['discount_rule_max_amt_count']['id'] .'_0' ?>" class="<?php echo $vtprd_deal_screen_framework['discount_rule_max_amt_count']['class']; ?>" type="<?php echo $vtprd_deal_screen_framework['discount_rule_max_amt_count']['type']; ?>" name="<?php echo $vtprd_deal_screen_framework['discount_rule_max_amt_count']['name'] .'_0' ;?>" value="<?php echo $vtprd_rule->rule_deal_info[0]['discount_rule_max_amt_count']; // use '0' deal_info_line...?>">
                </span>
            </span>
           <?php vtprd_show_help_selection_panel_H('0'); ?>
           ...
           <span class="text-field  clear-left" id="discount_rule_max_amt_msg">
            ...
            <div class="dropdown discount_rule_cum_max_amt_type clear-left" id="discount_rule_cum_max_amt_type_box">  
                 <?php
                   ...
                   //Both _label fields have trailing '_0', as edits are actually handled in the discount info loop ?>          
                <span class="title title-anchors second-level-title" id="discount_rule_cum_max_title_0" ><?php _e('Discount per Product Maximum:', 'vtprd');?></span>
                    <?php vtprd_show_help_tooltip($context = 'discount_rule_cum_max_amt_type', $location = 'title'); ?>
                <span class="shortIntro" ><?php echo __(' ... "GET A PRODUCT MAX DISCOUNT VALUE OF ', 'vtprd') .$currency_symbol.  __('30 ACROSS ALL RULES FOR THIS CART"...', 'vtprd'); ?></span>           
                <span class="dropdown clear-left" id="discount_rule_cum_max_dropdown">                                                         
                   ...
                   <span class="amt-field" id="discount_rule_cum_max_amt_count_area">
                      <span class="amt-field-label" id="discount_rule_cum_max_amt_count_label_0"> 
                          <span class="discount_rule_cum_max_amt_count_literal" id="discount_rule_cum_max_amt_count_literal_quantity"><?php _e('Qty: ', 'vtprd');?> </span> 
                          <span class="discount_rule_cum_max_amt_count_literal" id="discount_rule_cum_max_amt_count_literal_percent"><?php echo '%: ';?> </span>                          
                          <span class="discount_rule_cum_max_amt_count_literal" id="discount_rule_cum_max_amt_count_literal_currency"><?php echo $currency_symbol . ':'; ?> </span>                                  
                      </span>              
                     <input id="<?php echo $vtprd_deal_screen_framework['discount_rule_cum_max_amt_count']['id'] .'_0' ?>" class="<?php echo $vtprd_deal_screen_framework['discount_rule_cum_max_amt_count']['class']; ?>" type="<?php echo $vtprd_deal_screen_framework['discount_rule_cum_max_amt_count']['type']; ?>" name="<?php echo $vtprd_deal_screen_framework['discount_rule_cum_max_amt_count']['name'] .'_0' ;?>" value="<?php echo $vtprd_rule->rule_deal_info[0]['discount_rule_cum_max_amt_count']; // use '0' deal_info_line...?>">
                   </span>
                </span>
     ...
     ?>
        ...
        <span class="amt-field" id="singleChoiceIn-span">                                  
          ...
          <?php if ($vtprd_rule->inPop_singleProdID['value'] > ' ' ) { ?>           
              <span class="clear-left" id="singleProdID-in-name-area">
                <span class="amt-field-label" id="singleProdID-in-name-label"><?php _e('Buy Product Name:', 'vtprd');?></span>
        ...
        <div id="inPop-varProdID-cntl">            
          <a id="inPop-varProdID-more" class="help-anchor" href="javascript:void(0);"><?php _e('Buy Single Product with Variations - ', 'vtprd');?><span id="pop-in-more-help">More Info</span></a>
         ...
         <br><br>Rule overlap in variation rules is Not removed by the rule processing engine, it must be prevented here.'   , 'vtprd');?>             
         </p> 
          <div id="inPopVarBox">
              <h3 id="inPopVarBox_label"><?php _e('Single Product with Variations', 'vtprd');?>
                  <?php vtprd_show_help_tooltip($context = 'pop-prod-id', $location = 'title'); ?>
              </h3>
              <div id="inPopVarProduct">
                <span id="varProdID-in-label">&nbsp;&nbsp;<?php _e('Enter "Buy" Product ID Number', 'vtprd');?></span><br />                                    
              ...
              <div id="inPopVarButton">
                 <?php
                    $product_ID = $vtprd_rule->inPop_varProdID['value']; 
        ...
        <div class="" id="vtprd-pop-in-groups-cntl-help"> 
          <a id="groupsPop-in-more" class="groupsPop-help-in  more-anchor  hideMe" href="javascript:void(0);"><?php _e(' Selection Groups - More info (Context Help)...', 'vtprd'); ?>&nbsp;&nbsp;<img class="plus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
          <a id="groupsPop-in-less" class="groupsPop-help-in  more-anchor less-anchor  hideMe" href="javascript:void(0);"><?php _e(' Selection Groups - Less info ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>
        </div>
        
        <div class="" id="vtprd-pop-in-groups-cntl">             
        <div class="<?php //echo $groupPop_vis ?> " id="vtprd-pop-in-cntl">                                                           
         <?php vtprd_show_help_selection_panel_K(); ?>
        ...
        <div id="role-in">
          <h3 id="role-in-label"><?php _e('Role (Membership / Wholesaler)', 'vtprd');?></h3>
    ...
    ?>                                             
        ...
        <span class="amt-field" id="singleChoiceOut-span">                                  
          ...
          <?php if ($vtprd_rule->actionPop_singleProdID['value'] > ' ' ) { ?>           
              <span class="clear-left" id="singleProdID-out-name-area">
                <span class="amt-field-label"  id="singleProdID-out-name-label"><?php _e('Discount Product Name:', 'vtprd'); ?></span>
        ...
        <div id="actionPop-varProdID-cntl">            
          <a id="actionPop-varProdID-more" class="help-anchor" href="javascript:void(0);"><?php _e('Single Product with Variations - ', 'vtprd');?><span id="pop-out-more-help">More Info</span></a>
         <p id="actionPop-varProdID-descrip" class="help-text"><?php _e('When "Single Product with Variations" is chosen, at least one variation must be selected.
         <br><br> NB - PLEASE NOTE: If the product variation structure is changed in any way, you MUST return to the matching rule and reselect your variation choices.
         <br><br>Multiple rules may be created to apply to individual variations, or groups of variations within a product.           
         <br><br>Please be sure to prevent any rule overlap when applied to a given
            product-variation combination.  An overlap example: if there is a category-level rule covering an entire product, and an individual rule applying to any of the product variations.
         <br><br>Rule overlap in variation rules is Not removed by the rule processing engine, it must be prevented here.'   , 'vtprd');?>             
          ...
          <div id="actionPopVarBox">
              <h3 id="actionPopVarBox_label"><?php _e('Single Product with Variations', 'vtprd');?>
                  <?php vtprd_show_help_tooltip($context = 'pop-prod-id', $location = 'title'); ?>
              </h3>
              <div id="actionPopVarProduct">
                <span id="varProdID-out-label">&nbsp;&nbsp;<?php _e('Enter Discount Product ID Number', 'vtprd');?></span><br />                    
              ...
              <div id="actionPopVarButton">
                 <?php
                    $product_ID = $vtprd_rule->actionPop_varProdID['value']; 
                    $product_variation_IDs = vtprd_get_variations_list($product_ID);
                    /* ************************************************
                    **   Get Variations Button for Rule screen
                    *     ==>>> get the product id from $_REQUEST['varProdID'];  in the receiving ajax routine. 
        ...
        <div class="" id="vtprd-pop-out-cntl-help">                  
          <a id="groupsPop-out-more" class="groupsPop-help-out  more-anchor  hideMe" href="javascript:void(0);"><?php _e(' Selection Groups - More info (Context Help) ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="plus-button" alt="help" height="12px" width="12px"  src="<?php echo VTPRD_URL;?>/admin/images/plus-toggle2.png" /></a>
          <a id="groupsPop-out-less" class="groupsPop-help-out  more-anchor less-anchor  hideMe" href="javascript:void(0);"><?php _e(' Selection Groups - Less info ...', 'vtprd'); ?>&nbsp;&nbsp;<img class="minus-button" alt="help" height="12px" width="12px" src="<?php echo VTPRD_URL;?>/admin/images/minus-toggle2.png" /></a>
        </div>  
         
        <div class="" id="vtprd-pop-out-cntl">                                                  
         <?php vtprd_show_help_selection_panel_L(); ?>
    
        <div class="clear-left" id="prodcat-out">
          <h3><?php _e('Product Categories', 'vtprd');?></h3>
        ...
        <div id="rulecat-out">
          <h3><?php _e('Pricing Deals Categories', 'vtprd');?></h3>
        ...
        <div id="and-or-role-div">
          <?php
           for($i=0; $i < sizeof($vtprd_rule_display_framework['role_and_or_out']); $i++) { 
           ?>                               
              <input id="<?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['id']; ?>" class="<?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['class']; ?>" type="<?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['type']; ?>" name="<?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['name']; ?>" value="<?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['value']; ?>" <?php if ( $vtprd_rule_display_framework['role_and_or_out'][$i]['value'] == $vtprd_rule->role_and_or_out) { echo $checked; } ?>    /><span id="<?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['id'] . '-label'; ?>"> <?php echo $vtprd_rule_display_framework['role_and_or_out'][$i]['label']; ?></span><br /> 
           <?php } 
           //if neither 'and' nor 'or' selected, select 'or'
         /*  if ( (!$vtprd_rule_display_framework['role_and_or_out'][0]['user_input'] == 's') && (!$vtprd_rule_display_framework['role_and_or_out'][1]['user_input'] == 's') )   {
               $vtprd_rule_display_framework['role_and_or_out'][1]['user_input'] = 's';
           }   */
        ...
        <div id="role-out">
          <h3><?php _e('Role (Membership / Wholesaler)', 'vtprd');?></h3>
          
          <?php
          // ********************************
          $this->vtprd_post_category_meta_box($post, array( 'args' => array( 'taxonomy' => 'roles', 'tax_class' => 'role-out', 'checked_list' => $vtprd_rule->role_out_checked  )));
          // ********************************
          ?>
        </div>
  ...
  ?>
    ...
    public    function vtprd_rule_resources() {          
        echo '<span id="vtprd-rr-text">' . __('Read documentation, learn the functions and find some tips & tricks.', 'vtprd'). '</span><br>';
        echo '<a id="vtprd-rr-doc"  href="' . VTPRD_DOCUMENTATION_PATH_PRO_BY_PARENT . '"  title="Access Plugin Documentation">' . __('Plugin Documentation', 'vtprd'). '</a>';
        echo '<span id="vtprd-rr-text"><br><strong>' . __('Tip:', 'vtprd') .'</strong>'. __(' *Product*', 'vtprd') 
            .'<br>&nbsp;&nbsp;&nbsp;<em>'.
            __('inclusion or exclusion', 'vtprd')
            .'</em><br>&nbsp;&nbsp;&nbsp;' . __('for ', 'vtprd') .'<em>'. __('all rules', 'vtprd')
            .'</em><br>&nbsp;&nbsp;&nbsp;'.
            __('on Product page', 'vtprd')
            . '</span><br><br>';
        echo '<span id="vtprd-rr-box">';
        echo '<span id="vtprd-rr-created">by VarkTech.com</span>';
        echo '<a id="vtprd-rr-vote"  href="' . VTPRD_DOWNLOAD_FREE_VERSION_BY_PARENT . '"  title="' . __('Vote for the Plugin', 'vtprd'). '">Vote</a>';
    ...
    public    function vtprd_rule_scheduling() {             //periodicByDateRange
     ...
     ?> 
        <span class="basic-begin-date-area">          
          <span class="begin-date first-in-line-label" id='begin-date-label-0' >Begin Date: 
          </span>                    
        ...
        <span class="basic-end-date-area">          
          <span class="end-date first-in-line-label" id='end-date-label-0'>End Date: 
          </span>                     
  ...
  public function vtprd_build_checkbox_contents ($taxonomy, $tax_class, $checked_list = NULL, $pop_in_out_sw ) {
    ...
    global $wpdb, $post, $vtprd_rule;
        ...
        ********************************************* */
    $vtprd_rule->inPop_varProdID['value']  = $_POST['inVarProdID'];  //from var *passed in from ajax js     
    $product_ID = $vtprd_rule->inPop_varProdID['value'];
    ...
    global $wpdb, $post, $vtprd_rule;
       /*  *********************************************
         ...
         which displays as an errant '0' with the ajax display. 
        ********************************************* */
    $vtprd_rule->actionPop_varProdID['value']  = $_POST['outVarProdID'];  //from var *passed in from ajax js     
    $product_ID = $vtprd_rule->actionPop_varProdID['value'];
  ...
  public function vtprd_ajax_show_variations_in ($product_variation_IDs) {
     ...
     <?php
            //********************************
            $this->vtprd_post_category_meta_box($post, array( 'args' => array( 'taxonomy' => 'variations', 'tax_class' => 'var-in', 'checked_list' => $vtprd_rule->var_in_checked, 'product_ID' => $vtprd_rule->inPop_varProdID['value'], 'product_variation_IDs' => $product_variation_IDs )));
            // ******************************** 
  ...
  public function vtprd_ajax_show_variations_out ($product_variation_IDs) {
     ...
     <?php
            //********************************
            $this->vtprd_post_category_meta_box($post, array( 'args' => array( 'taxonomy' => 'variations', 'tax_class' => 'var-out', 'checked_list' => $vtprd_rule->var_out_checked, 'product_ID' => $vtprd_rule->actionPop_varProdID['value'], 'product_variation_IDs' => $product_variation_IDs )));
            // ********************************                 
  } 
  ...
  */      
        ...
        <div class="dropdown includeOrExclude_area clear-left" id="includeOrExclude_areaID">              
          ...
          <div id="includeOrExclude-all" class="tabs-panel">
            ...
            <p id="includeOrExclude-area-title2"><?php _e("These selections do not ", 'vtprd'); echo '<em>'; _e("force", 'vtprd'); echo '</em>'; 
                _e(" the product's participation in a rule.  ", 'vtprd'); echo '<em>'; _e("Inclusion only applies if the product naturally falls
  ...
  public  function vtprd_build_new_rule() {
      global $post, $vtprd_info, $vtprd_rule, $vtprd_rules_set, $vtprd_deal_structure_framework; 
        ...
        $vtprd_rule->cumulativeRulePricing = 'no';  
        $vtprd_rule->cumulativeSalePricing = 'no';  
        $vtprd_rule->cumulativeCouponPricing = 'no';
